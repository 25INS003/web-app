...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-slate-900 p-4 lg:p-8 relative overflow-hidden">
             {/* Ambient Background */}
            ...
            <motion.div 
                ...
                className="relative z-10 w-full max-w-[500px] bg-slate-800 rounded-3xl shadow-2xl overflow-hidden border border-white/10"
            >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            <FloatingLabelInput
                                ...
                                className="bg-slate-900/50 border-slate-700 text-white focus:border-blue-500"
                            />
                        </motion.div>
                        ...
                        >
                                ...
                                />
                                <label htmlFor="remember" className="text-sm font-medium text-slate-400 cursor-pointer select-none hover:text-slate-300 transition-colors">Remember me</label>
                                </div>
